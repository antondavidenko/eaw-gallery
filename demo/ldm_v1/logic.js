...
function playVideo() {
	...
	if (this.door==1) { gameView.showDoor1(); }
	else if (this.door==2) { gameView.showDoor2(); }
	else if (this.door==3) { gameView.showDoor3(); }
}
...
function init() {
	...
	exportRoot = new lib.JS_LuckyDip();
...
function eventFromFlash(event) {
	if (event == "180")	{gameView.setupPlayNow();}
