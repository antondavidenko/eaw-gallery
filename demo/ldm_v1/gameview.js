...
//-----------------------------------------------------------------------	
	function StateBeforePlay() {	
		...
		this.onLogoStart = function() { 
			$("#"+STATE_BEFORE_PLAY).hide();
			_flashStage.children[0].gotoAndPlay(90);
		}
	...
	function statePlayNow() {
		...
		this.showDoor1 = function() { 
			_flashStage.children[0].gotoAndPlay(269);
		} 

		this.showDoor2 = function() { 
			_flashStage.children[0].gotoAndPlay(307);
		} 

		this.showDoor3 = function() { 
			_flashStage.children[0].gotoAndPlay(345);
		} 		
