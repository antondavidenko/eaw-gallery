...
//-----------------------------------------------------------------------	
	...
	function statePlayNow() {
		...
		this.showDoor1 = function() { 
			_flashStage.children[0].gotoAndPlay(31);
			_flashStage.children[0].door1_mc.play();
			_flashStage.children[0].door1_mc.visible = true;
			_flashStage.children[0].door2_mc.visible = false;
			_flashStage.children[0].door3_mc.visible = false;
		} 

		this.showDoor2 = function() { 
			_flashStage.children[0].gotoAndPlay(31);
			_flashStage.children[0].door2_mc.play();
			_flashStage.children[0].door2_mc.visible = true;			
			_flashStage.children[0].door1_mc.visible = false;
			_flashStage.children[0].door3_mc.visible = false;
		} 

		this.showDoor3 = function() { 
			_flashStage.children[0].gotoAndPlay(31);
			_flashStage.children[0].door3_mc.play();
			_flashStage.children[0].door3_mc.visible = true;			
			_flashStage.children[0].door2_mc.visible = false;
			_flashStage.children[0].door1_mc.visible = false;
		} 		
