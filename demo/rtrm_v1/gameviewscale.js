var GameViewScale = function() 
{
	GameViewScale.prototype.viewInit = function() // TO SCALE CLASS
	{
		...
		autoScaleElement("#startGameButton1","forcedResize");
		applyScaleFactorToElement("#startGameButton1","noResize");		
		autoScaleElement("#startGameButton2","forcedResize");
		applyScaleFactorToElement("#startGameButton2","noResize");		
		autoScaleElement("#startGameButton3","forcedResize");
		applyScaleFactorToElement("#startGameButton3","noResize");		
