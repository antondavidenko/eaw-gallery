...
//-----------------------------------------------------------------------	
	...
	function statePlayNow() {
		...
		this.showDoor1 = function() { 
			_flashStage.children[0].gotoAndPlay(82);
			_flashStage.children[0].rocket1anim.play();
			_flashStage.children[0].rocket2anim.visible = false;
			_flashStage.children[0].rocket3anim.visible = false;
		} 

		this.showDoor2 = function() { 
			_flashStage.children[0].gotoAndPlay(82);
			_flashStage.children[0].rocket2anim.play();
			_flashStage.children[0].rocket1anim.visible = false;
			_flashStage.children[0].rocket3anim.visible = false;
		} 

		this.showDoor3 = function() { 
			_flashStage.children[0].gotoAndPlay(82);
			_flashStage.children[0].rocket3anim.play();
			_flashStage.children[0].rocket2anim.visible = false;
			_flashStage.children[0].rocket1anim.visible = false;
		} 		
