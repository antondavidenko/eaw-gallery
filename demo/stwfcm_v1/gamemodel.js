var GameModel = function() {}
	...
	GameModel.prototype.imgStart = imgSetup("start/00", 6, 1);
	GameModel.prototype.imgRoll = imgSetup("roll/00", 3, 1);
	
	imgLose1tmp = imgSetup("lose1/00", 5, 1, false);
	GameModel.prototype.imgLose1 = [imgLose1tmp[0], imgLose1tmp[1], imgLose1tmp[2], imgLose1tmp[2], imgLose1tmp[2], imgLose1tmp[2], imgLose1tmp[2], imgLose1tmp[2], imgLose1tmp[3], imgLose1tmp[4], ]
	imgLose2tmp = imgSetup("lose2/00", 5, 1, false);
	GameModel.prototype.imgLose2 = [imgLose2tmp[0], imgLose2tmp[1], imgLose2tmp[2], imgLose2tmp[2], imgLose2tmp[2], imgLose2tmp[2], imgLose2tmp[2], imgLose2tmp[2], imgLose2tmp[3], imgLose2tmp[4], ]

	GameModel.prototype.imgWin1 = imgSetup("win1/00", 25, 1, false);
	GameModel.prototype.imgWin2 = imgSetup("win2/00", 25, 1, false);
	GameModel.prototype.imgWin3 = imgSetup("win3/00", 25, 1, false);